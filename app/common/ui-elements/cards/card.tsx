...
export const Card: FC<CardProps> = ({ title, to, children, linkText }) => {
  return (
    <li className={clsx(
      ...
      {children}
      {!!(to && linkText) && <MaybeLinkedContent to={to}>{linkText}</MaybeLinkedContent>}
    </li>
  );
};

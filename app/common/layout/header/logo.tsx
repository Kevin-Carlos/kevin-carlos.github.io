...
export const Logo = () => {
  return (
    <Link to={links.home()} className="focus:outline-theme-dteal dark:focus:outline-theme-orange rounded-full focus:outline-offset-2 focus:outline focus:outline-2">

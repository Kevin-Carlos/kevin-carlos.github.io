...
var AnimatedHello = () => {
  ...
  const [items] = (0, import_react.useState)(helloInLanguages.map((hi) => ({ value: hi, sort: Math.random() })).sort((a, b) => a.sort - b.sort).map((v) => v.value));
  const [index, setIndex] = (0, import_react.useState)(0);
  const [length, setLength] = (0, import_react.useState)(helloInLanguages[index].length);
  ...
  return /* @__PURE__ */ import_react.default.createElement("span", {
    ...
    className: "relative"
  }, transitions((styles, i) => /* @__PURE__ */ import_react.default.createElement(animated.span, {
    ref: valueRef,
    style: { ...styles, position: "absolute" }
  }, items[i], ",")), /* @__PURE__ */ import_react.default.createElement(animated.span, {
    key: length,
    style: {
      position: "absolute",
      left
...
function Index() {
  ...
  const [mode] = useTheme();
  const getParticleOptions = (0, import_react2.useCallback)((mode2) => {
    const opts = {
      fpsLimit: 60,
      detectRetina: true,
      retina_detect: true,
...
//# sourceMappingURL=/build/routes/index-7M24PGDF.js.map

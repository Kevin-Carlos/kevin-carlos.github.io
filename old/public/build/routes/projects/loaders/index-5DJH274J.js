...
var HaloCountdown = () => {
  ...
  const transitions = useTransition(showCountdown, {
    from: { translateY: "translateY(-50%)" },
    enter: { translateY: "translateY(0)" },
    leave: { translateY: "translateY(-50%)" },
    delay: 200
  });
  ...
  }, showCountdown && /* @__PURE__ */ React.createElement(React.Fragment, null, transitions(({ translateY }) => {
...
//# sourceMappingURL=/build/routes/projects/loaders/index-5DJH274J.js.map

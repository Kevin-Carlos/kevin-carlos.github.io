...
var PulsingDots = re("div", {
  ...
  "& > div:first-child": {
    animation: `${pulse} 0.7s infinite linear 0s`
  },
  "& > div:nth-child(2)": {
    animation: `${pulse} 0.7s infinite linear 0.5s`
  },
  "& > div:last-child": {
    animation: `${pulse} 0.7s infinite 0.7s`
  }
});
var Spinners = () => {
...
//# sourceMappingURL=/build/routes/projects/loaders/index-VG24RMFX.js.map

...
var HaloCountdown = () => {
  ...
  const springInLeftBorderStyles = useSpring({
    to: [
      { transform: "translate3d(-50%, 0, 0) scale(1)" },
      {
        left: 0
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "w-[1px] bg-theme-orange h-full absolute scale-0",
    style: springInLeftBorderStyles
  }), /* @__PURE__ */ React.createElement(animated.div, {
...
//# sourceMappingURL=/build/routes/projects/loaders/index-ALYGAEVU.js.map

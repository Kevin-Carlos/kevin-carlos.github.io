...
var HaloCountdown = () => {
  ...
  const [springInStyles, spring] = useSpring(() => ({
    from: {
      transform: showCountdown ? "translate3d(-50%, 50%, 0) scale(0)" : "translate3d(-50%, -50%, 0) scale(0)"
    },
    to: {
...
//# sourceMappingURL=/build/routes/projects/loaders/index-7ZS64FUH.js.map

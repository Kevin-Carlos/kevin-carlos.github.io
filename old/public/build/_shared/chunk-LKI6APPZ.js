...
var Switch2 = ({ ...props }) => {
  var _a;
  const [isChecked, setIsChecked] = (0, import_react18.useState)((_a = props.checked) != null ? _a : false);
  return /* @__PURE__ */ import_react18.default.createElement(Root3, {
    ...props,
    onCheckedChange: (c) => {
  ...
  }, /* @__PURE__ */ import_react18.default.createElement(Thumb2, {
    checked: isChecked
  }));
};
...
// app/common/layout/menu-items.tsx
var ICON_SIZE = 24;
var ImageIcons = ({ ...props }) => /* @__PURE__ */ import_react19.default.createElement("img", {
...
var menuItems = [
  {
    name: "Home",
    path: links.home(),
    icon: /* @__PURE__ */ import_react19.default.createElement(ImageIcons, {
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ import_react19.default.createElement(Code_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
      "aria-label": "Projects",
  ...
  },
  {
    name: "About Me",
    path: links.aboutMe(),
    icon: /* @__PURE__ */ import_react19.default.createElement(UserFocus_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
      "aria-label": "About Me",
      className: "dark:text-theme-white text-theme-black hover:!text-theme-blue dark:hover:!text-theme-orange transition-colors duration-[250ms] ease-in-out"
  ...
  },
  {
    name: "LinkedIn",
    path: links.linkedIn(),
    icon: /* @__PURE__ */ import_react19.default.createElement(LinkedinLogo_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
  ...
  },
  {
    name: "GitHub",
    path: links.github(),
    icon: /* @__PURE__ */ import_react19.default.createElement(GithubLogo_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
  ...
  },
  {
    name: "GitLab",
    path: links.gitlab(),
    icon: /* @__PURE__ */ import_react19.default.createElement(GitlabLogo_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
...
var HamburgerIcon = ({
  ...
  }, /* @__PURE__ */ import_react21.default.createElement(HamburgerBar, {
    isOpen,
    number: 1
  }), /* @__PURE__ */ import_react21.default.createElement(HamburgerBar, {
    isOpen,
...
var useOnce = (effect) => (0, import_react22.useEffect)(effect, emptyDeps);
var emptyDeps = [];
function useForceUpdate() {
  const update3 = (0, import_react22.useState)()[1];
  const mounted = (0, import_react22.useState)(makeMountedRef)[0];
...
function useMemoOne(getResult, inputs) {
  const [initial] = (0, import_react22.useState)(() => ({
    inputs,
    result: getResult()
  }));
  const committed = (0, import_react22.useRef)();
...
function usePrev(value) {
  const prevRef = (0, import_react22.useRef)();
  (0, import_react22.useEffect)(() => {
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react23.forwardRef)((givenProps, givenRef) => {
    ...
    const ref = hasInstance && (0, import_react23.useCallback)((value) => {
...
function useSprings(length, props, deps) {
  ...
  if (propsFn && !deps)
    deps = [];
  const ref = (0, import_react24.useMemo)(() => propsFn || arguments.length == 3 ? SpringRef() : void 0, []);
...
function useTransition(data, props, deps) {
  ...
  const transitions = [];
  const usedTransitions = (0, import_react24.useRef)(null);
  ...
  const exitingTransitions = (0, import_react24.useRef)(/* @__PURE__ */ new Map());
  const forceChange = (0, import_react24.useRef)(false);
  ...
  const renderTransitions = (render) => React16.createElement(React16.Fragment, null, transitions.map((t4, i3) => {
    const {
      springs
...
var HamburgerMenu = ({
  ...
  return /* @__PURE__ */ import_react25.default.createElement(animated.menu, {
    style: spring,
  ...
  }, menuItems.map((i3, idx) => /* @__PURE__ */ import_react25.default.createElement("li", {
    key: `ham-${i3.name}_${idx}`,
    className: "flex justify-center w-full"
  }, /* @__PURE__ */ import_react25.default.createElement(LinkText, {
    href: i3.path,
    className: "text-2xl",
    childrenClassName: "grid grid-cols-[1fr_200px] justify-items-center",
    animateScale: false
  }, i3.icon, /* @__PURE__ */ import_react25.default.createElement("span", {
...
var Header = () => {
  ...
  const [mobileNav, toggleMobileNav] = (0, import_react27.useState)(false);
  const menuRef = (0, import_react27.useRef)(null);
  useClickOutside(menuRef, () => toggleMobileNav(false));
  const setIsOpen = (0, import_react27.useCallback)(() => {
  ...
  return /* @__PURE__ */ React.createElement("header", {
    ...
    return /* @__PURE__ */ React.createElement(import_react27.Fragment, {
      key: `header-${mi.name}`
...
var Layout = ({ children, hideFooter }) => {
  return /* @__PURE__ */ React.createElement(import_react28.Fragment, null, /* @__PURE__ */ React.createElement("div", {
...
//# sourceMappingURL=/build/_shared/chunk-LKI6APPZ.js.map

...
var TabsList = ({ children, className }) => {
  return /* @__PURE__ */ React.createElement(StyledOL, null, Array.isArray(children) ? children.map((c6) => c6) : children);
};
...
var ue = import_react18.default.createContext();
var le = ue.Consumer;
var de = import_react18.default.createContext();
var he = (de.Consumer, new Z2());
var pe = ce();
function fe() {
  return (0, import_react18.useContext)(ue) || he;
}
function me() {
  return (0, import_react18.useContext)(de) || pe;
}
function ye(e8) {
  var t6 = (0, import_react18.useState)(e8.stylisPlugins), n5 = t6[0], s4 = t6[1], c6 = fe(), u4 = (0, import_react18.useMemo)(function() {
    var t7 = c6;
  ...
  }, [e8.disableCSSOMInjection, e8.sheet, e8.target]), l6 = (0, import_react18.useMemo)(function() {
  ...
  }, [e8.stylisPlugins]), import_react18.default.createElement(ue.Provider, { value: u4 }, import_react18.default.createElement(de.Provider, { value: l6 }, true ? import_react18.default.Children.only(e8.children) : e8.children));
}
var ve = function() {
  function e8(e9, t6) {
    var n5 = this;
...
var Pe = function(e8, t6) {
  if (true) {
    ...
    try {
      (0, import_react18.useRef)(), Ie.has(n5) || (console.warn(n5), Ie.add(n5));
    } catch (e9) {
...
var ze = import_react18.default.createContext();
var Le = ze.Consumer;
var Fe = {};
function Ye(e8, t6, n5) {
  ...
  var C2, I3 = new se(n5, g3, o6 ? e8.componentStyle : void 0), P3 = I3.isStatic && c6.length === 0, O2 = function(e9, t7) {
    return function(e10, t8, n6, r4) {
      ...
      (0, import_react18.useDebugValue)(h5);
      ...
      }(Oe(t8, (0, import_react18.useContext)(ze), a5) || E2, t8, o7), y3 = f3[0], g4 = f3[1], S4 = function(e11, t9, n7, r5) {
        var o8 = fe(), s4 = me(), i7 = t9 ? e11.generateAndInjectStyles(E2, o8, s4) : e11.generateAndInjectStyles(n7, o8, s4);
        return (0, import_react18.useDebugValue)(i7), !t9 && r5 && r5(i7), i7;
      ...
      return t8.style && g4.style !== t8.style && (C3.style = v2({}, t8.style, {}, g4.style)), C3.className = Array.prototype.concat(c7, h5, S4 !== h5 ? S4 : null, t8.className, g4.className).filter(Boolean).join(" "), C3.ref = w3, (0, import_react18.createElement)(_2, C3);
    }(C2, e9, t7, P3);
  };
  return O2.displayName = f2, (C2 = import_react18.default.forwardRef(O2)).attrs = S3, C2.componentStyle = I3, C2.displayName = f2, C2.shouldForwardProp = A3, C2.foldedComponentIds = o6 ? Array.prototype.concat(e8.foldedComponentIds, e8.styledComponentId) : w2, C2.styledComponentId = g3, C2.target = o6 ? e8.target : e8, C2.withComponent = function(e9) {
...
var Ue = function() {
  function e8() {
    ...
    this._emitSheetCSS = function() {
      ...
      return o6 && (n5.nonce = o6), [import_react18.default.createElement("style", v2({}, n5, { key: "sc-0-0" }))];
    }, this.seal = function() {
      e9.sealed = true;
  ...
  return t6.collectStyles = function(e9) {
    return this.sealed ? j2(2) : import_react18.default.createElement(ye, { sheet: this.instance }, e9);
...
var Switch2 = ({ ...props }) => {
  var _a;
  const [isChecked, setIsChecked] = (0, import_react19.useState)((_a = props.checked) != null ? _a : false);
  return /* @__PURE__ */ import_react19.default.createElement(Root3, {
    ...props,
    onCheckedChange: (c6) => {
  ...
  }, /* @__PURE__ */ import_react19.default.createElement(Thumb2, {
    $checked: isChecked
  }));
};
...
// app/common/layout/menu-items.tsx
var ICON_SIZE = 24;
var ImageIcons = ({ ...props }) => /* @__PURE__ */ import_react20.default.createElement("img", {
...
var menuItems = [
  {
    name: "Home",
    path: links.home(),
    icon: /* @__PURE__ */ import_react20.default.createElement(ImageIcons, {
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ import_react20.default.createElement(Code_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
      "aria-label": "Projects",
  ...
  },
  {
    name: "About Me",
    path: links.aboutMe(),
    icon: /* @__PURE__ */ import_react20.default.createElement(UserFocus_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
      "aria-label": "About Me",
      className: "dark:text-theme-white text-theme-black hover:!text-theme-blue dark:hover:!text-theme-orange transition-colors duration-[250ms] ease-in-out"
  ...
  },
  {
    name: "LinkedIn",
    path: links.linkedIn(),
    icon: /* @__PURE__ */ import_react20.default.createElement(LinkedinLogo_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
  ...
  },
  {
    name: "GitHub",
    path: links.github(),
    icon: /* @__PURE__ */ import_react20.default.createElement(GithubLogo_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
  ...
  },
  {
    name: "GitLab",
    path: links.gitlab(),
    icon: /* @__PURE__ */ import_react20.default.createElement(GitlabLogo_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
...
var HamburgerIcon = ({
  ...
  }, /* @__PURE__ */ import_react22.default.createElement(HamburgerBar, {
    isOpen,
    number: 1
  }), /* @__PURE__ */ import_react22.default.createElement(HamburgerBar, {
    isOpen,
...
var useOnce = (effect) => (0, import_react23.useEffect)(effect, emptyDeps);
var emptyDeps = [];
function useForceUpdate() {
  const update3 = (0, import_react23.useState)()[1];
  const mounted = (0, import_react23.useState)(makeMountedRef)[0];
...
function useMemoOne(getResult, inputs) {
  const [initial] = (0, import_react23.useState)(() => ({
    inputs,
    result: getResult()
  }));
  const committed = (0, import_react23.useRef)();
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react24.forwardRef)((givenProps, givenRef) => {
    const instanceRef = (0, import_react24.useRef)(null);
    const ref = hasInstance && (0, import_react24.useCallback)((value) => {
    ...
    const observerRef = (0, import_react24.useRef)();
    useLayoutEffect2(() => {
...
function useSprings(length, props, deps) {
  ...
  if (propsFn && !deps)
    deps = [];
  const ref = (0, import_react25.useMemo)(() => propsFn || arguments.length == 3 ? SpringRef() : void 0, []);
  const layoutId = (0, import_react25.useRef)(0);
  const forceUpdate = useForceUpdate();
  const state = (0, import_react25.useMemo)(() => ({
    ctrls: [],
    queue: [],
    flush(ctrl, updates2) {
  ...
  const ctrls = (0, import_react25.useRef)([...state.ctrls]);
  const updates = [];
...
var HamburgerMenu = ({
  ...
  return /* @__PURE__ */ import_react26.default.createElement(animated.menu, {
    style: spring,
    className: "bg-theme-lteal absolute top-0 right-0 h-screen w-screen z-40"
  }, /* @__PURE__ */ import_react26.default.createElement("nav", {
    role: "navigation",
  ...
  }, menuItems.map((i5, idx) => /* @__PURE__ */ import_react26.default.createElement("li", {
    key: `ham-${i5.name}_${idx}`,
    className: "flex justify-center w-full"
  }, /* @__PURE__ */ import_react26.default.createElement(LinkText, {
    href: i5.path,
    className: "text-2xl",
    childrenClassName: "grid grid-cols-[1fr_200px] justify-items-center",
    animateScale: false
  }, i5.icon, /* @__PURE__ */ import_react26.default.createElement("span", {
...
var Header = () => {
  ...
  const [mobileNav, toggleMobileNav] = (0, import_react28.useState)(false);
  const menuRef = (0, import_react28.useRef)(null);
  useClickOutside(menuRef, () => toggleMobileNav(false));
  const setIsOpen = (0, import_react28.useCallback)(() => {
  ...
  return /* @__PURE__ */ React.createElement("header", {
    ...
    return /* @__PURE__ */ React.createElement(import_react28.Fragment, {
      key: `header-${mi.name}`
...
var Layout = ({ children, hideFooter }) => {
  return /* @__PURE__ */ React.createElement(import_react29.Fragment, null, /* @__PURE__ */ React.createElement("div", {
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-2BBISV5P.js.map

...
import {
  ...
  styled,
  useFetcher
} from "/build/_shared/chunk-MY3YDAZT.js";
import {
  React,
  __toESM,
  init_react,
...
var Switch2 = ({ ...props }) => {
  var _a;
  const [isChecked, setIsChecked] = (0, import_react16.useState)((_a = props.checked) != null ? _a : false);
  return /* @__PURE__ */ import_react16.default.createElement(Root3, {
    ...props,
    onCheckedChange: (c) => {
  ...
  }, /* @__PURE__ */ import_react16.default.createElement(Thumb2, {
    checked: isChecked
  }));
};
...
// app/common/layout/menu-items.tsx
var ICON_SIZE = 24;
var ImageIcons = ({ ...props }) => /* @__PURE__ */ import_react17.default.createElement("img", {
...
var menuItems = [
  {
    name: "Home",
    path: links.home(),
    icon: /* @__PURE__ */ import_react17.default.createElement(ImageIcons, {
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ import_react17.default.createElement(Code_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
      "aria-label": "Projects",
  ...
  },
  {
    name: "About Me",
    path: links.aboutMe(),
    icon: /* @__PURE__ */ import_react17.default.createElement(UserFocus_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
      "aria-label": "About Me",
      className: "dark:text-theme-white text-theme-black hover:!text-theme-blue dark:hover:!text-theme-orange transition-colors duration-[250ms] ease-in-out"
  ...
  },
  {
    name: "LinkedIn",
    path: links.linkedIn(),
    icon: /* @__PURE__ */ import_react17.default.createElement(LinkedinLogo_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
  ...
  },
  {
    name: "GitHub",
    path: links.github(),
    icon: /* @__PURE__ */ import_react17.default.createElement(GithubLogo_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
  ...
  },
  {
    name: "GitLab",
    path: links.gitlab(),
    icon: /* @__PURE__ */ import_react17.default.createElement(GitlabLogo_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
...
var useOnce = (effect) => (0, import_react19.useEffect)(effect, emptyDeps);
var emptyDeps = [];
function useForceUpdate() {
  const update3 = (0, import_react19.useState)()[1];
  const mounted = (0, import_react19.useState)(makeMountedRef)[0];
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react20.forwardRef)((givenProps, givenRef) => {
    ...
    const ref = hasInstance && (0, import_react20.useCallback)((value) => {
    ...
    return React14.createElement(Component, _extends3({}, usedProps, {
      ref
    }));
  });
};
...
var SpringContext = (_ref) => {
  ...
  const inherited = (0, import_react21.useContext)(ctx);
...
function useSprings(length, props, deps) {
  ...
  if (propsFn && !deps)
    deps = [];
  const ref = (0, import_react21.useMemo)(() => propsFn || arguments.length == 3 ? SpringRef() : void 0, []);
...
function useTransition(data, props, deps) {
  ...
  const transitions = [];
  const usedTransitions = (0, import_react21.useRef)(null);
  ...
  const exitingTransitions = (0, import_react21.useRef)(/* @__PURE__ */ new Map());
  const forceChange = (0, import_react21.useRef)(false);
  ...
  const renderTransitions = (render) => React15.createElement(React15.Fragment, null, transitions.map((t4, i3) => {
    const {
      springs
    } = changes.get(t4) || t4.ctrl;
    const elem = render(_extends4({}, springs), t4.item, t4, i3);
    return elem && elem.type ? React15.createElement(elem.type, _extends4({}, elem.props, {
...
var HamburgerMenu = ({
  ...
  return /* @__PURE__ */ import_react22.default.createElement(animated.menu, {
    style: spring,
    className: "bg-theme-lteal absolute top-0 right-0 h-screen w-screen z-40"
  }, /* @__PURE__ */ import_react22.default.createElement("nav", {
    role: "navigation",
  ...
  }, menuItems.map((i3, idx) => /* @__PURE__ */ import_react22.default.createElement("li", {
    key: `ham-${i3.name}_${idx}`,
    className: "flex justify-center w-full"
  }, /* @__PURE__ */ import_react22.default.createElement(LinkText, {
    href: i3.path,
    className: "text-2xl",
    childrenClassName: "grid grid-cols-[1fr_200px] justify-items-center",
    animateScale: false
  }, i3.icon, /* @__PURE__ */ import_react22.default.createElement("span", {
...
var Header = () => {
  ...
  const [mobileNav, toggleMobileNav] = (0, import_react25.useState)(false);
  const menuRef = (0, import_react25.useRef)(null);
  useClickOutside(menuRef, () => toggleMobileNav(false));
  const setIsOpen = (0, import_react25.useCallback)(() => {
    toggleMobileNav(!mobileNav);
  }, [mobileNav]);
  return /* @__PURE__ */ React.createElement(StyledHeader, {
    role: "banner"
  }, /* @__PURE__ */ React.createElement(LogoAndModeWrapper, null, /* @__PURE__ */ React.createElement(Logo, null), /* @__PURE__ */ React.createElement(themeMode.Form, {
    method: "post",
    action: "/theme/mode"
    ...
    onClick: () => {
      themeMode.submit({ method: "post", action: "/theme/mode" });
      setMode("dark");
    }
...
var Layout = ({ children, hideFooter }) => {
  return /* @__PURE__ */ React.createElement(import_react26.Fragment, null, /* @__PURE__ */ React.createElement(LayoutGrid, null, /* @__PURE__ */ React.createElement(Header, null), /* @__PURE__ */ React.createElement(Main, {
    role: "main"
...
//# sourceMappingURL=/build/_shared/chunk-YH3WXEE4.js.map

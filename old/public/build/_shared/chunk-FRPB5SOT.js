import {
  require_react_dom
} from "/build/_shared/chunk-ZHTSBDCV.js";
import {
  ThemeCtx
} from "/build/_shared/chunk-QN6MRT7M.js";
import {
  Link
} from "/build/_shared/chunk-SZWNMIY4.js";
import {
  React,
  __toESM,
  init_react,
...
var o = () => {
  ...
  return (t5, r3, ...n4) => {
    ...
    return o5 in e7 ? e7[o5] : e7[o5] = r3(t5, ...n4);
  };
};
...
var h = /([\d.]+)([^]*)/;
var f = (e7, t5) => e7.length ? e7.reduce((e8, r3) => (e8.push(...t5.map((e9) => e9.includes("&") ? e9.replace(/&/g, /[ +>|~]/.test(r3) && /&.*&/.test(e9) ? `:is(${r3})` : r3) : r3 + " " + e9)), e8), []) : t5;
var m = (e7, t5) => e7 in b && typeof t5 == "string" ? t5.replace(/^((?:[^]*[^\w-])?)(fit-content|stretch)((?:[^\w-][^]*)?)$/, (t6, r3, n4, i4) => r3 + (n4 === "stretch" ? `-moz-available${i4};${d(e7)}:${r3}-webkit-fill-available` : `-moz-fit-content${i4};${d(e7)}:${r3}fit-content`) + i4) : String(t5);
...
var S = (e7) => e7 ? e7 + "-" : "";
var k = (e7, t5, r3) => e7.replace(/([+-])?((?:\d+(?:\.\d*)?|\.\d+)(?:[Ee][+-]?\d+)?)?(\$|--)([$\w-]+)/g, (e8, n4, i4, o5, l5) => o5 == "$" == !!i4 ? e8 : (n4 || o5 == "--" ? "calc(" : "") + "var(--" + (o5 === "$" ? S(t5) + (l5.includes("$") ? "" : S(r3)) + l5.replace(/\$/g, "-") : l5) + ")" + (n4 || o5 == "--" ? "*" + (n4 || "") + (i4 || "1") + ")" : ""));
var y = /\s*,\s*(?![^()]*\))/;
  ...
  const a3 = (e8, t6, r4) => {
    ...
    const p3 = (e9) => {
      for (c6 in e9) {
        ...
        for (g2 of z2) {
          const e10 = /[A-Z]/.test($2 = c6) ? $2 : $2.replace(/-[^]/g, (e11) => e11[1].toUpperCase()), z3 = typeof g2 == "object" && g2 && g2.toString === B && (!n4.utils[e10] || !t6.length);
          ...
          if (R2 && (b3 = c6.slice(1) in n4.media ? "@media " + n4.media[c6.slice(1)] : c6, c6 = b3.replace(/\(\s*([\w-]+)\s*(=|<|<=|>|>=)\s*([\w-]+)\s*(?:(<|<=|>|>=)\s*([\w-]+)\s*)?\)/g, (e11, t7, r5, n5, i5, o6) => {
            const l6 = h.test(t7), s4 = 0.0625 * (l6 ? -1 : 1), [a4, c7] = l6 ? [n5, t7] : [t7, n5];
            return "(" + (r5[0] === "=" ? "" : r5[0] === ">" === l6 ? "max-" : "min-") + a4 + ":" + (r5[0] !== "=" && r5.length === 1 ? c7.replace(h, (e12, t8, n6) => Number(t8) + s4 * (r5 === ">" ? 1 : -1) + n6) : c7) + (i5 ? ") and (" + (i5[0] === ">" ? "min-" : "max-") + a4 + ":" + (i5.length === 1 ? o6.replace(h, (e12, t8, r6) => Number(t8) + s4 * (i5 === ">" ? -1 : 1) + r6) : o6) : "") + ")";
          })), z3) {
            const e11 = R2 ? r4.concat(c6) : [...r4], n5 = R2 ? [...t6] : f(t6, c6.split(y));
            o5 !== void 0 && i4(x(...o5)), o5 = void 0, a3(g2, n5, e11);
          } else
            o5 === void 0 && (o5 = [[], t6, r4]), c6 = R2 || c6.charCodeAt(0) !== 36 ? c6 : `--${S(n4.prefix)}${c6.slice(1).replace(/\$/g, "-")}`, g2 = z3 ? g2 : typeof g2 == "number" ? g2 && e10 in I ? String(g2) + "px" : String(g2) : k(m(e10, g2 == null ? "" : g2), n4.prefix, n4.themeMap[e10]), o5[0].push(`${R2 ? `${c6} ` : `${d(c6)}:`}${g2}`);
        }
      }
      var b3, $2;
    };
...
var x = (e7, t5, r3) => `${r3.map((e8) => `${e8}{`).join("")}${t5.length ? `${t5.join(",")}{` : ""}${e7.join(";")}${t5.length ? "}" : ""}${Array(r3.length ? r3.length + 1 : 0).join("}")}`;
...
var E = (e7) => {
  ...
  const r3 = () => {
    ...
    return [].map.call(e8, (r4, n5) => {
      ...
      if (e8[n5 - 1] && (o5 = e8[n5 - 1].cssText).startsWith("--sxs")) {
        ...
        for (const e9 in t5.rules)
          if (t5.rules[e9].group === r4)
            return `--sxs{--sxs:${[...t5.rules[e9].cache].join(" ")}}${i4}`;
        return r4.cssRules.length ? `${o5}${i4}` : "";
      }
      return i4;
    }).join("");
  }, n4 = () => {
    if (t5) {
      const { rules: e8, sheet: r4 } = t5;
      if (!r4.deleteRule) {
    ...
    for (const e8 of i4)
      if (j(e8)) {
        for (let i5 = 0, o6 = e8.cssRules; o6[i5]; ++i5) {
          ...
          d2 && (t5 || (t5 = { sheet: e8, reset: n4, rules: {}, toString: r3 }), t5.rules[d2] = { group: s3, index: i5, cache: new Set(c6) });
        }
        if (t5)
          break;
      }
    if (!t5) {
      ...
      t5 = { sheet: e7 ? (e7.head || e7).appendChild(document.createElement("style")).sheet : i5("", "text/css"), rules: {}, reset: n4, toString: r3 };
    }
    const { sheet: o5, rules: l5 } = t5;
    for (let e8 = W.length - 1; e8 >= 0; --e8) {
      const t6 = W[e8];
      if (!l5[t6]) {
        const r4 = W[e8 + 1], n5 = l5[r4] ? l5[r4].index : o5.cssRules.length;
...
var v = (e7) => {
  const t5 = e7.group;
  let r3 = t5.cssRules.length;
  e7.apply = (e8) => {
    try {
      t5.insertRule(e8, r3), ++r3;
    } catch (e9) {
    }
  };
};
...
var C = ({ variants: e7, compoundVariants: t5, defaultVariants: r3, ...n4 }, i4) => {
...
var P = (e7, t5, r3) => {
  const [n4, i4, o5, a3] = L(t5.composers), c6 = typeof t5.type == "function" || t5.type.$$typeof ? ((e8) => {
    function t6() {
      for (let r4 = 0; r4 < t6[T].length; r4++) {
        const [n5, i5] = t6[T][r4];
        e8.rules[n5].apply(i5);
      }
      return t6[T] = [], null;
    }
    return t6[T] = [], t6.rules = {}, W.forEach((e9) => t6.rules[e9] = { apply: (r4) => t6[T].push([e9, r4]) }), t6;
  })(r3) : null, d2 = (c6 || r3).rules, g2 = `.${n4}${i4.length > 1 ? `:where(.${i4.slice(1).join(".")})` : ""}`, p3 = (l5) => {
    l5 = typeof l5 == "object" && l5 || A;
    const { css: s3, ...p4 } = l5, u3 = {};
    for (const e8 in o5)
      if (delete p4[e8], e8 in l5) {
        let t6 = l5[e8];
        typeof t6 == "object" && t6 ? u3[e8] = { "@initial": o5[e8], ...t6 } : (t6 = String(t6), u3[e8] = t6 !== "undefined" || a3.has(e8) ? t6 : o5[e8]);
      } else
        u3[e8] = o5[e8];
    const h3 = /* @__PURE__ */ new Set([...i4]);
    for (const [n5, i5, o6, l6] of t5.composers) {
      r3.rules.styled.cache.has(n5) || (r3.rules.styled.cache.add(n5), $(i5, [`.${n5}`], [], e7, (e8) => {
        d2.styled.apply(e8);
      }));
      ...
      for (const i6 of t6)
        if (i6 !== void 0)
          for (const [t7, o7, l7] of i6) {
            const i7 = `${n5}-${z(o7)}-${t7}`;
            h3.add(i7);
            const s5 = (l7 ? r3.rules.resonevar : r3.rules.onevar).cache, a4 = l7 ? d2.resonevar : d2.onevar;
      ...
      for (const t7 of s4)
        if (t7 !== void 0)
          for (const [i6, o7] of t7) {
            const t8 = `${n5}-${z(o7)}-${i6}`;
            h3.add(t8), r3.rules.allvar.cache.has(t8) || (r3.rules.allvar.cache.add(t8), $(o7, [`.${t8}`], [], e7, (e8) => {
              d2.allvar.apply(e8);
            }));
          }
    }
    if (typeof s3 == "object" && s3) {
      ...
      h3.add(t6), r3.rules.inline.cache.has(t6) || (r3.rules.inline.cache.add(t6), $(s3, [`.${t6}`], [], e7, (e8) => {
        d2.inline.apply(e8);
      }));
    }
  ...
  return s(p3, { className: n4, selector: g2, [l]: t5, toString: () => (r3.rules.styled.cache.has(n4) || p3(), n4) });
};
var L = (e7) => {
  let t5 = "";
  const r3 = [], n4 = {}, i4 = [];
  for (const [o5, , , , l5, s3] of e7) {
    t5 === "" && (t5 = o5), r3.push(o5), i4.push(...s3);
    for (const e8 in l5) {
      const t6 = l5[e8];
      (n4[e8] === void 0 || t6 !== "undefined" || s3.includes(t6)) && (n4[e8] = t6);
    }
  }
  return [t5, r3, n4, new Set(i4)];
};
var O = (e7, t5, r3, n4) => {
  const i4 = [];
  e:
            ...
            for (const l6 in i5) {
              if (n5 === String(i5[l6])) {
                if (l6 !== "@initial") {
                  ...
                  (t6 = t6 || []).push(e10 in r3 ? r3[e10] : l6.replace(/^@media ?/, "")), c6 = true;
                }
                a3 += o6, e9 = true;
              }
              ++o6;
...
var D = (e7, t5) => N(e7, () => (...r3) => {
  const n4 = () => {
    for (let n5 of r3) {
      ...
      let r4 = z(n5);
      if (!t5.rules.global.cache.has(r4)) {
        if (t5.rules.global.cache.add(r4), "@import" in n5) {
          let e8 = [].indexOf.call(t5.sheet.cssRules, t5.rules.themed.group) - 1;
          for (let r5 of [].concat(n5["@import"]))
            r5 = r5.includes('"') || r5.includes("'") ? r5 : `"${r5}"`, t5.sheet.insertRule(`@import ${r5};`, e8++);
          delete n5["@import"];
        }
        $(n5, [], [], e7, (e8) => {
...
var H = o();
var V = (e7, t5) => H(e7, () => (r3) => {
  const n4 = `${S(e7.prefix)}k-${z(r3)}`, i4 = () => {
...
var G = class {
  constructor(e7, t5, r3, n4) {
    this.token = e7 == null ? "" : String(e7), this.value = t5 == null ? "" : String(t5), this.scale = r3 == null ? "" : String(r3), this.prefix = n4 == null ? "" : String(n4);
  }
  get computedValue() {
...
var F = o();
var J = (e7, t5) => F(e7, () => (r3, n4) => {
  n4 = typeof r3 == "object" && r3 || Object(n4);
  const i4 = `.${r3 = (r3 = typeof r3 == "string" ? r3 : "") || `${S(e7.prefix)}t-${z(n4)}`}`, o5 = {}, l5 = [];
  for (const t6 in n4) {
    o5[t6] = {};
    for (const r4 in n4[t6]) {
      const i5 = `--${S(e7.prefix)}${t6}-${r4}`, s4 = k(String(n4[t6][r4]), e7.prefix, t6);
      o5[t6][r4] = new G(r4, s4, t6, e7.prefix), l5.push(`${i5}:${s4}`);
    }
  }
  const s3 = () => {
    if (l5.length && !t5.rules.themed.cache.has(r3)) {
      t5.rules.themed.cache.add(r3);
      const i5 = `${n4 === e7.theme ? ":root," : ""}.${r3}{${l5.join(";")}}`;
...
var q = (e7) => {
  const t5 = ((e8) => {
    ...
    return t6 || r3.reset(), r3;
  })(e7);
  return t5.styled = (({ config: e8, sheet: t6 }) => Y(e8, () => {
    const r3 = M(e8, t6);
    return (...e9) => {
      const t7 = r3(...e9), n4 = t7[l].type, i4 = import_react6.default.forwardRef((e10, r4) => {
        const i5 = e10 && e10.as || n4, { props: o5, deferredInjector: l5 } = t7(e10);
        return delete o5.as, o5.ref = r4, l5 ? import_react6.default.createElement(import_react6.default.Fragment, null, import_react6.default.createElement(i5, o5), import_react6.default.createElement(l5, null)) : import_react6.default.createElement(i5, o5);
      });
...
var Slot = /* @__PURE__ */ t2.forwardRef((e7, o5) => {
  ...
  return t2.Children.toArray(a3).some(l2) ? /* @__PURE__ */ t2.createElement(t2.Fragment, null, t2.Children.map(a3, (e8) => l2(e8) ? /* @__PURE__ */ t2.createElement(n2, _extends({}, s3, { ref: o5 }), e8.props.children) : e8)) : /* @__PURE__ */ t2.createElement(n2, _extends({}, s3, { ref: o5 }), a3);
});
Slot.displayName = "Slot";
var n2 = /* @__PURE__ */ t2.forwardRef((r3, n4) => {
  const { children: l5, ...a3 } = r3;
  return t2.isValidElement(l5) ? /* @__PURE__ */ t2.cloneElement(l5, { ...o3(a3, l5.props), ref: composeRefs(n4, l5.ref) }) : t2.Children.count(l5) > 1 ? t2.Children.only(null) : null;
});
...
var Primitive = ["a", "button", "div", "h2", "h3", "img", "li", "nav", "ol", "p", "span", "svg", "ul"].reduce((o5, i4) => ({ ...o5, [i4]: /* @__PURE__ */ r2.forwardRef((o6, m3) => {
  const { asChild: a3, ...s3 } = o6, n4 = a3 ? Slot : i4;
  return r2.useEffect(() => {
    window[Symbol.for("radix-ui")] = true;
  }, []), /* @__PURE__ */ r2.createElement(n4, _extends({}, s3, { ref: m3 }));
}) }), {});
...
var Separator = /* @__PURE__ */ o4.forwardRef((n4, a3) => {
  const { decorative: p3, orientation: l5 = e2, ...c6 } = n4, s3 = i2(l5) ? l5 : e2, u3 = p3 ? { role: "none" } : { "aria-orientation": s3 === "vertical" ? s3 : void 0, role: "separator" };
  return o4.createElement(Primitive.div, _extends({ "data-orientation": s3 }, u3, c6, { ref: a3 }));
});
function i2(r3) {
  return n3.includes(r3);
}
Separator.propTypes = { orientation(r3, o5, t5) {
  const n4 = r3[o5], a3 = String(n4);
  return n4 && !i2(n4) ? new Error(function(r4, o6) {
...
function useControllableState({ prop: o5, defaultProp: r3, onChange: n4 = () => {
  ...
  }({ defaultProp: r3, onChange: n4 }), c6 = o5 !== void 0, f2 = c6 ? o5 : a3, l5 = useCallbackRef(n4);
...
var Switch = /* @__PURE__ */ s2.forwardRef((r3, o5) => {
  const { __scopeSwitch: c6, "aria-labelledby": l5, name: u3, checked: m3, defaultChecked: f2, required: x2, disabled: k2, value: w2 = "on", onCheckedChange: v2, ...S2 } = r3, [y2, E2] = s2.useState(null), C2 = useComposedRefs(o5, (e7) => E2(e7)), g2 = useLabelContext(y2), R2 = l5 || g2, T2 = s2.useRef(false), P2 = !y2 || Boolean(y2.closest("form")), [_ = false, q2] = useControllableState({ prop: m3, defaultProp: f2, onChange: v2 });
  return s2.createElement(p2, { scope: c6, checked: _, disabled: k2 }, /* @__PURE__ */ s2.createElement(Primitive.button, _extends({ type: "button", role: "switch", "aria-checked": _, "aria-labelledby": R2, "aria-required": x2, "data-state": h2(_), "data-disabled": k2 ? "" : void 0, disabled: k2, value: w2 }, S2, { ref: C2, onClick: composeEventHandlers(r3.onClick, (e7) => {
...
var SwitchThumb = /* @__PURE__ */ s2.forwardRef((e7, r3) => {
  const { __scopeSwitch: o5, ...a3 } = e7, c6 = m2("SwitchThumb", o5);
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react25.forwardRef)((givenProps, givenRef) => {
    ...
    return React15.createElement(Component, _extends3({}, usedProps, {
      ref
    }));
  });
};
...
function useSprings(length, props, deps) {
  ...
  const values = springs.map((x2) => _extends4({}, x2));
...
var useSpringRef = () => (0, import_react26.useState)(initSpringRef)[0];
var TransitionPhase;
...
function useTransition(data, props, deps) {
  ...
  const renderTransitions = (render) => React16.createElement(React16.Fragment, null, transitions.map((t5, i4) => {
    ...
    const elem = render(_extends4({}, springs), t5.item, t5, i4);
    return elem && elem.type ? React16.createElement(elem.type, _extends4({}, elem.props, {
...
var HamburgerMenu = ({
  ...
  return /* @__PURE__ */ import_react27.default.createElement(animated.menu, {
  ...
  }, menuItems.map((i4, idx) => /* @__PURE__ */ import_react27.default.createElement("li", {
    ...
    animateScale: false
  }, i4.icon, /* @__PURE__ */ import_react27.default.createElement("span", {
...
//# sourceMappingURL=/build/_shared/chunk-FRPB5SOT.js.map

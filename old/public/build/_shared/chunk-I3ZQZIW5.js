...
function useControllableState({ prop: o6, defaultProp: r4, onChange: n5 = () => {
  ...
  const [a4, u4] = function({ defaultProp: o7, onChange: r5 }) {
    const n6 = t3.useState(o7), [a5] = n6, u5 = t3.useRef(a5), c7 = useCallbackRef(r5);
    return t3.useEffect(() => {
...
function createContext3(t6, n5) {
  ...
  function r4(t7) {
    const { children: n6, ...r5 } = t7, c6 = e5.useMemo(() => r5, Object.values(r5));
...
function createContextScope(n5, o6 = []) {
  ...
  return c6.scopeName = n5, [function(t6, o7) {
    const c7 = /* @__PURE__ */ e5.createContext(o7), u4 = r4.length;
    function s4(t7) {
      const { scope: o8, children: r5, ...s5 } = t7, i5 = (o8 == null ? void 0 : o8[n5][u4]) || c7, a4 = e5.useMemo(() => s5, Object.values(s5));
...
var SwitchThumb = /* @__PURE__ */ s2.forwardRef((e8, r4) => {
  ...
  return s2.createElement(Primitive.span, _extends({ "data-state": h2(c6.checked), "data-disabled": c6.disabled ? "" : void 0 }, a4, { ref: r4 }));
});
var b2 = (e8) => {
  const { control: t6, checked: a4, bubbles: c6 = true, ...i5 } = e8, n5 = s2.useRef(null), l6 = usePrevious(a4), u4 = useSize(t6);
  return s2.useEffect(() => {
  ...
  }, [l6, a4, c6]), /* @__PURE__ */ s2.createElement("input", _extends({ type: "checkbox", "aria-hidden": true, defaultChecked: a4 }, i5, { tabIndex: -1, ref: n5, style: { ...e8.style, ...u4, position: "absolute", pointerEvents: "none", opacity: 0, margin: 0 } }));
};
function h2(e8) {
...
var ue = import_react20.default.createContext();
var le = ue.Consumer;
var de = import_react20.default.createContext();
var he = (de.Consumer, new Z2());
var pe = ce();
function fe() {
  return (0, import_react20.useContext)(ue) || he;
}
function me() {
  return (0, import_react20.useContext)(de) || pe;
}
function ye(e8) {
  var t6 = (0, import_react20.useState)(e8.stylisPlugins), n5 = t6[0], s4 = t6[1], c6 = fe(), u4 = (0, import_react20.useMemo)(function() {
    var t7 = c6;
  ...
  }, [e8.disableCSSOMInjection, e8.sheet, e8.target]), l6 = (0, import_react20.useMemo)(function() {
  ...
  }, [e8.stylisPlugins]), import_react20.default.createElement(ue.Provider, { value: u4 }, import_react20.default.createElement(de.Provider, { value: l6 }, true ? import_react20.default.Children.only(e8.children) : e8.children));
}
var ve = function() {
  function e8(e9, t6) {
    var n5 = this;
...
var Pe = function(e8, t6) {
  if (true) {
    ...
    try {
      (0, import_react20.useRef)(), Ie.has(n5) || (console.warn(n5), Ie.add(n5));
    } catch (e9) {
...
var ze = import_react20.default.createContext();
var Le = ze.Consumer;
var Fe = {};
function Ye(e8, t6, n5) {
  ...
  var C2, I3 = new se(n5, g3, o6 ? e8.componentStyle : void 0), P3 = I3.isStatic && c6.length === 0, O2 = function(e9, t7) {
    return function(e10, t8, n6, r4) {
      ...
      (0, import_react20.useDebugValue)(h5);
      ...
      }(Oe(t8, (0, import_react20.useContext)(ze), a5) || E2, t8, o7), y3 = f3[0], g4 = f3[1], S4 = function(e11, t9, n7, r5) {
        var o8 = fe(), s4 = me(), i7 = t9 ? e11.generateAndInjectStyles(E2, o8, s4) : e11.generateAndInjectStyles(n7, o8, s4);
        return (0, import_react20.useDebugValue)(i7), !t9 && r5 && r5(i7), i7;
      ...
      return t8.style && g4.style !== t8.style && (C3.style = v2({}, t8.style, {}, g4.style)), C3.className = Array.prototype.concat(c7, h5, S4 !== h5 ? S4 : null, t8.className, g4.className).filter(Boolean).join(" "), C3.ref = w3, (0, import_react20.createElement)(_2, C3);
    }(C2, e9, t7, P3);
  };
  return O2.displayName = f2, (C2 = import_react20.default.forwardRef(O2)).attrs = S3, C2.componentStyle = I3, C2.displayName = f2, C2.shouldForwardProp = A3, C2.foldedComponentIds = o6 ? Array.prototype.concat(e8.foldedComponentIds, e8.styledComponentId) : w2, C2.styledComponentId = g3, C2.target = o6 ? e8.target : e8, C2.withComponent = function(e9) {
...
var Ue = function() {
  function e8() {
    ...
    this._emitSheetCSS = function() {
      ...
      return o6 && (n5.nonce = o6), [import_react20.default.createElement("style", v2({}, n5, { key: "sc-0-0" }))];
    }, this.seal = function() {
      e9.sealed = true;
  ...
  return t6.collectStyles = function(e9) {
    return this.sealed ? j2(2) : import_react20.default.createElement(ye, { sheet: this.instance }, e9);
...
var Switch2 = ({ ...props }) => {
  var _a;
  const [isChecked, setIsChecked] = (0, import_react21.useState)((_a = props.checked) != null ? _a : false);
  ...
  }, /* @__PURE__ */ import_react21.default.createElement(Thumb2, {
    $checked: isChecked
  }));
};
...
// app/common/layout/menu-items.tsx
var ICON_SIZE = 24;
var ImageIcons = ({ ...props }) => /* @__PURE__ */ import_react22.default.createElement("img", {
...
var menuItems = [
  {
    name: "Home",
    path: links.home(),
    icon: /* @__PURE__ */ import_react22.default.createElement(ImageIcons, {
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ import_react22.default.createElement(Code_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
      "aria-label": "Projects",
  ...
  },
  {
    name: "About Me",
    path: links.aboutMe(),
    icon: /* @__PURE__ */ import_react22.default.createElement(UserFocus_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
      "aria-label": "About Me",
      className: "dark:text-theme-white text-theme-black hover:!text-theme-blue dark:hover:!text-theme-orange transition-colors duration-[250ms] ease-in-out"
  ...
  },
  {
    name: "LinkedIn",
    path: links.linkedIn(),
    icon: /* @__PURE__ */ import_react22.default.createElement(LinkedinLogo_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
  ...
  },
  {
    name: "GitHub",
    path: links.github(),
    icon: /* @__PURE__ */ import_react22.default.createElement(GithubLogo_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
  ...
  },
  {
    name: "GitLab",
    path: links.gitlab(),
    icon: /* @__PURE__ */ import_react22.default.createElement(GitlabLogo_esm_default, {
      size: ICON_SIZE,
      weight: "duotone",
...
var HamburgerIcon = ({
  ...
  }, /* @__PURE__ */ import_react24.default.createElement(HamburgerBar, {
    isOpen,
    number: 1
  }), /* @__PURE__ */ import_react24.default.createElement(HamburgerBar, {
    isOpen,
...
var useOnce = (effect) => (0, import_react25.useEffect)(effect, emptyDeps);
var emptyDeps = [];
function useForceUpdate() {
  const update3 = (0, import_react25.useState)()[1];
  const mounted = (0, import_react25.useState)(makeMountedRef)[0];
...
function useMemoOne(getResult, inputs) {
  const [initial] = (0, import_react25.useState)(() => ({
    inputs,
    result: getResult()
  }));
  const committed = (0, import_react25.useRef)();
...
function usePrev(value) {
  const prevRef = (0, import_react25.useRef)();
  (0, import_react25.useEffect)(() => {
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react26.forwardRef)((givenProps, givenRef) => {
    const instanceRef = (0, import_react26.useRef)(null);
    const ref = hasInstance && (0, import_react26.useCallback)((value) => {
    ...
    const observerRef = (0, import_react26.useRef)();
    useLayoutEffect2(() => {
    ...
    (0, import_react26.useEffect)(callback, []);
    useOnce(() => () => {
...
var SpringContext = (_ref) => {
  ...
  const inherited = (0, import_react27.useContext)(ctx);
...
function useSprings(length, props, deps) {
  ...
  if (propsFn && !deps)
    deps = [];
  const ref = (0, import_react27.useMemo)(() => propsFn || arguments.length == 3 ? SpringRef() : void 0, []);
  const layoutId = (0, import_react27.useRef)(0);
  const forceUpdate = useForceUpdate();
  ...
  const ctrls = (0, import_react27.useRef)([...state.ctrls]);
  const updates = [];
  ...
  const values = springs.map((x3) => _extends4({}, x3));
...
function useTransition(data, props, deps) {
  ...
  const renderTransitions = (render) => React16.createElement(React16.Fragment, null, transitions.map((t6, i5) => {
    ...
    const elem = render(_extends4({}, springs), t6.item, t6, i5);
...
var HamburgerMenu = ({
  ...
  return /* @__PURE__ */ import_react28.default.createElement(animated.menu, {
    style: spring,
    className: "bg-theme-lteal absolute top-0 right-0 h-screen w-screen z-40"
  }, /* @__PURE__ */ import_react28.default.createElement("nav", {
    role: "navigation",
  ...
  }, menuItems.map((i5, idx) => /* @__PURE__ */ import_react28.default.createElement("li", {
    key: `ham-${i5.name}_${idx}`,
    className: "flex justify-center w-full"
  }, /* @__PURE__ */ import_react28.default.createElement(LinkText, {
    href: i5.path,
    className: "text-2xl",
    childrenClassName: "grid grid-cols-[1fr_200px] justify-items-center",
    animateScale: false
  }, i5.icon, /* @__PURE__ */ import_react28.default.createElement("span", {
...
var Header = () => {
  ...
  const [mobileNav, toggleMobileNav] = (0, import_react30.useState)(false);
  ...
  return /* @__PURE__ */ React.createElement("header", {
    ...
    return /* @__PURE__ */ React.createElement(import_react30.Fragment, {
      key: `header-${mi.name}`
    }, /* @__PURE__ */ React.createElement(LinkText, {
      href: mi.path
    }, mi.name), idx !== menuItems.length - 1 ? /* @__PURE__ */ React.createElement(Divider, {
      orientation: "vertical",
      className: "bg-theme-dteal dark:bg-theme-dteal dark:before:bg-theme-dteal before:bg-theme-dteal dark:after:bg-theme-dteal after:bg-theme-dteal"
    }) : null);
  })), /* @__PURE__ */ React.createElement("div", {
    ref: menuRef,
...
var Layout = ({ children, hideFooter }) => {
  return /* @__PURE__ */ React.createElement(import_react31.Fragment, null, /* @__PURE__ */ React.createElement("div", {
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-I3ZQZIW5.js.map

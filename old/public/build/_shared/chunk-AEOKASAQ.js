...
function ye(e8) {
  var t6 = (0, import_react3.useState)(e8.stylisPlugins), n5 = t6[0], s4 = t6[1], c3 = fe(), u4 = (0, import_react3.useMemo)(function() {
    var t7 = c3;
  ...
  }, [e8.disableCSSOMInjection, e8.sheet, e8.target]), l6 = (0, import_react3.useMemo)(function() {
  ...
  }, [e8.stylisPlugins]), import_react3.default.createElement(ue.Provider, { value: u4 }, import_react3.default.createElement(de.Provider, { value: l6 }, true ? import_react3.default.Children.only(e8.children) : e8.children));
}
var ve = function() {
  function e8(e9, t6) {
    var n5 = this;
...
var Pe = function(e8, t6) {
  if (true) {
    ...
    try {
      (0, import_react3.useRef)(), Ie.has(n5) || (console.warn(n5), Ie.add(n5));
    } catch (e9) {
...
var ze = import_react3.default.createContext();
var Le = ze.Consumer;
var Fe = {};
function Ye(e8, t6, n5) {
  ...
  var C2, I3 = new se(n5, g3, o6 ? e8.componentStyle : void 0), P3 = I3.isStatic && c3.length === 0, O2 = function(e9, t7) {
    return function(e10, t8, n6, r4) {
      ...
      (0, import_react3.useDebugValue)(h5);
      ...
      }(Oe(t8, (0, import_react3.useContext)(ze), a5) || E2, t8, o7), y3 = f3[0], g4 = f3[1], S4 = function(e11, t9, n7, r5) {
        var o8 = fe(), s4 = me(), i7 = t9 ? e11.generateAndInjectStyles(E2, o8, s4) : e11.generateAndInjectStyles(n7, o8, s4);
        return (0, import_react3.useDebugValue)(i7), !t9 && r5 && r5(i7), i7;
      ...
      return t8.style && g4.style !== t8.style && (C3.style = v2({}, t8.style, {}, g4.style)), C3.className = Array.prototype.concat(c4, h5, S4 !== h5 ? S4 : null, t8.className, g4.className).filter(Boolean).join(" "), C3.ref = w3, (0, import_react3.createElement)(_2, C3);
    }(C2, e9, t7, P3);
  };
  return O2.displayName = f2, (C2 = import_react3.default.forwardRef(O2)).attrs = S3, C2.componentStyle = I3, C2.displayName = f2, C2.shouldForwardProp = A3, C2.foldedComponentIds = o6 ? Array.prototype.concat(e8.foldedComponentIds, e8.styledComponentId) : w2, C2.styledComponentId = g3, C2.target = o6 ? e8.target : e8, C2.withComponent = function(e9) {
...
var Ue = function() {
  function e8() {
    ...
    this._emitSheetCSS = function() {
      ...
      return o6 && (n5.nonce = o6), [import_react3.default.createElement("style", v2({}, n5, { key: "sc-0-0" }))];
    }, this.seal = function() {
      e9.sealed = true;
  ...
  return t6.collectStyles = function(e9) {
    return this.sealed ? j2(2) : import_react3.default.createElement(ye, { sheet: this.instance }, e9);
...
var Switch2 = ({ ...props }) => {
  var _a;
  const [isChecked, setIsChecked] = (0, import_react4.useState)((_a = props.checked) != null ? _a : false);
  return /* @__PURE__ */ import_react4.default.createElement(Root3, {
    ...props,
    onCheckedChange: (c3) => {
  ...
  }, /* @__PURE__ */ import_react4.default.createElement(Thumb2, {
    $checked: isChecked
  }));
};
 ...
 */
//# sourceMappingURL=/build/_shared/chunk-AEOKASAQ.js.map
